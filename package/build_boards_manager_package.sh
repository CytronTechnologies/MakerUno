...
sudo wget -qO avr-${ARDUINO_VER}.tar.bz2 http://downloads.arduino.cc/cores/avr-${ARDUINO_VER}.tar.bz2
...
if [ -e "\$srcdir/package/package_cytron_makeruno_index.json" ]; then
