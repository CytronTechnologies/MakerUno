...
git clone https://github.com/CytronTechnologies/MakerUno_Examples.git $srcdir/$outdir/libraries/MakerUno_Examples
ls -a $srcdir/$outdir/libraries/MakerUno_Examples/*
